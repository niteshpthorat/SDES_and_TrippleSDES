...
public class CASCII {
  ...
  public static char Convert( byte[] bits, int start, int end)
  {
    ...
    if ( end - start != 4 )
    {
      throw new IllegalArgumentException("Argument must only be five bits long");
    }
    ...
    switch ( val )
    {
      ...
      default:
        throw new IllegalArgumentException("Argument must be be on interval [0, 31]");
      }
  }
